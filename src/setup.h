...
#define LED_PLUS_MINUS_GPIO_PINS  (GPIO_PIN_4 | GPIO_PIN_3 )
//red
...
#define OUT_NUSE_PIN (GPIO_PIN_2) //OC4
...
#define LED_UP_PIN (GPIO_PIN_3) //led4
// #define LED_DOWN_PIN (GPIO_PIN_2) //led2
#define LED_DOWN_PIN (GPIO_PIN_4) //led3
...
#define LED_PLUS_MINUS_OFF (GPIO_WriteLow(LED_GPIO_PORT, LED_PLUS_MINUS_GPIO_PINS))
#define LED_PLUS_MINUS_ON (GPIO_WriteHigh(LED_GPIO_PORT, LED_PLUS_MINUS_GPIO_PINS))
// #define LED_UP_ON (GPIO_WriteLow(LED_GPIO_PORT, LED_UP_PIN))
// #define LED_UP_OFF (GPIO_WriteHigh(LED_GPIO_PORT, LED_UP_PIN))
#define LED_UP_OFF (GPIO_WriteLow(LED_GPIO_PORT, LED_UP_PIN))
#define LED_UP_ON (GPIO_WriteHigh(LED_GPIO_PORT, LED_UP_PIN))
// #define LED_DOWN_ON (GPIO_WriteLow(LED_GPIO_PORT, LED_DOWN_PIN))
// #define LED_DOWN_OFF (GPIO_WriteHigh(LED_GPIO_PORT, LED_DOWN_PIN))
#define LED_DOWN_OFF (GPIO_WriteLow(LED_GPIO_PORT, LED_DOWN_PIN))
#define LED_DOWN_ON (GPIO_WriteHigh(LED_GPIO_PORT, LED_DOWN_PIN))
